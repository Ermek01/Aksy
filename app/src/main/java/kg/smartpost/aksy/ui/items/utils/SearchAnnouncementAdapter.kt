...
class SearchAnnouncementAdapter(private val announcementClickListener: AnnouncementClickListener) :
    ListAdapter<ModelSearchItems.Item, SearchAnnouncementAdapter.ViewHolderCat>(DIFF) {

    fun getItemAtPos(position: Int): ModelSearchItems.Item {
    ...
    companion object {
        private val DIFF = object : DiffUtil.ItemCallback<ModelSearchItems.Item>() {
            override fun areItemsTheSame(oldItem: ModelSearchItems.Item, newItem: ModelSearchItems.Item): Boolean {
                return oldItem.id == newItem.id
            }

            override fun areContentsTheSame(
                oldItem: ModelSearchItems.Item,
                newItem: ModelSearchItems.Item
            ): Boolean {
                return oldItem.id == newItem.id
            }
        }
